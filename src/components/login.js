      ...
      <div className="w-full px-6 py-6 mt-3 overflow-hidden bg-white shadow-md sm:max-w-lg sm:rounded-lg">
        ...
        <div className="mt-8">
          ...
          <div className="mt-8 flex flex-col gap-y-4">
            <button
              className="active:scale-[.80] active:duration-75 transition-all hover:scale-[1.01] ease-in-out transform py-5 rounded-xl text-white font-bold text-lg"
              style={{
                background:
          ...
          {loginError && (
            <p className="mt-4 text-red-500 text-sm">{loginError}</p>
          )}
